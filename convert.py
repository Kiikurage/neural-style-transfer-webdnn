...
from webdnn.frontend.chainer import ChainerConverter, PlaceholderVariable
from webdnn.graph.placeholder import Placeholder


# Models
class NSTModelPath(Enum):
    starrynight = "./chainer-fast-neuralstyle-models/models/starrynight.model"
    scream = "./chainer-fast-neuralstyle-models/models/scream-style.model"
    fur = "./chainer-fast-neuralstyle-models/models/fur_0.model"
    candy = "./chainer-fast-neuralstyle-models/models/candy_512_2_49000.model"
    kanagawa = "./chainer-fast-neuralstyle-models/models/kanagawa.model"
...
# By using "Placeholder" object, actual input image size can be determined at runtime.
H = Placeholder(label="H")
W = Placeholder(label="W")

# You can use　the "PlaceholderVariable" instance like "chainer.Variable".
x = PlaceholderVariable([1, 3, H, W])
